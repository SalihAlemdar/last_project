                    ...
                    child: FadeInAnimation(
                      child: CurvedBox(
                        children: [
                          ...
                          Text(note.text.substring(0, note.text.length > 50 ? 50 : note.text.length)),
                          const SizedBox(
                            height: 16,
                          ),
                          DateFooter(date: "${note.updataedAt.year}:${note.updataedAt.month}:${note.updataedAt.day}", footerText: 'Salih')
                        ],
                      ),
                      // child: i == 0
                      //     ? CurvedBox(
                      ...
                      //             height: 8,
                      //           ),
                      //           const _ListTileRow(isChecked: true, text: 'Exploration Design'),
                      //           const _ListTileRow(isChecked: true, text: 'Kuliah'),
                      //           const _ListTileRow(isChecked: false, text: 'Learn 3D model'),
                      //           const _ListTileRow(isChecked: false, text: 'Design Shots'),
                      //           const SizedBox(
                      //             height: 16,
                      //           ),
                      ...
                      //                 height: 8,
                      //               ),
                      //               const Text('''"The best preparation for tomorrow is doing your best today"\n- H. Jackson Jr.'''),
                      //               const SizedBox(
                      //                 height: 16,
                      //               ),
                      ...
                      //                     height: 8,
                      //                   ),
                      //                   const Text('I have a dream that must come true !!'),
                      //                   const _ListTileRow(isChecked: true, text: 'GPA above 3.60'),
                      //                   const _ListTileRow(isChecked: true, text: 'Have an ipad'),
                      //                   const _ListTileRow(isChecked: false, text: 'Holidays in Japan'),
                      //                   const SizedBox(
                      //                     height: 16,
                      //                   ),
...
class _ListTileRow extends StatelessWidget {
  const _ListTileRow({Key? key, required this.isChecked, required this.text}) : super(key: key);
  final String text;
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(
          child: Text(text, style: TextStyle(decoration: isChecked ? TextDecoration.lineThrough : null)),
        )
      ],
    );
  }
